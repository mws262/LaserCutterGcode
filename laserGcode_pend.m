...
pic = rgb2gray(imread('pend2.png')); %Read image, convert to grayscale
...
% resizedPic = imrotate(resizedPic,pi/2);
...
inversepic = resizedPic;%imcomplement(resizedPic); %Invert the picture so that 255 means DARK, and 1 means LIGHT
