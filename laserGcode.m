...
desiredLength = 70; %desired engraving length in mm
...
yoffset = 0;
xoffset2 = 0; %How much upper left corner of print is offset from the origin.
yoffset2 = 0;
%pic = imread('gramletter.jpg');
pic = rgb2gray(imread('heartnote.jpg')); %Read image, convert to grayscale
